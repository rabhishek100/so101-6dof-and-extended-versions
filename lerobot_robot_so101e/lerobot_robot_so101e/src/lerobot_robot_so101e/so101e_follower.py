...
class SO101EFollower(Robot):
    """
    Modified SO-101 follower with a seventh DoF that rotates the elbow.

    The extra servo lets us decouple forearm roll from the wrist, which improves
    reachability for in-hand manipulation tasks.
    """
    ...
    def configure(self) -> None:
        with self.bus.torque_disabled():
            ...
            for motor in self.bus.motors:
                ...
                if motor == "gripper":
                    # Conservative defaults to protect the gripper gearbox.
